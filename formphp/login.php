...
if (isset($_POST['login'])) {
  ...
  if ($result == 1) {
    header("location:http://localhost/start_php/formphp/table.php");
  } else {
    header("locatioin://localhost/start_php/formphp/login.php");
  }
}
?>
  ...
  <div class="container0 bg-secondary">
    ...
    <form action="login.php" method="POST">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Email address" aria-describedby="emailHelp" name="email">
